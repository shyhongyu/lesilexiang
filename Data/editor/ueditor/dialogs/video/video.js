...
(function(){
    ...
    function insertSingle(){
        ...
        //---------除了swf，flv，其他都使用video20190916
        var videoFlag = 0;
        if (url.indexOf('.') != -1) {
            var ext = url.split('.').pop().toLowerCase();
            if (ext.length >5 ||  ext =='swf' || ext == 'flv' || ext == 'html' || ext == 'htm') {
                videoFlag = 0
            } else {
                videoFlag = 1;
            }
        ...
        }, isModifyUploadVideo ? 'upload':( videoFlag ? 'upload' : null));
    }
    ...
    function createPreviewVideo(url){
        ...
        if (videoFlag) {
            ...
            '<video class="previewVideo"' +
                ...
                ' width="' + 420  + '"' +
                ' height="' + 280  + '"' +
                ' autoplay="true" preload="metadata" controls="controls">' +
            '</video>';
