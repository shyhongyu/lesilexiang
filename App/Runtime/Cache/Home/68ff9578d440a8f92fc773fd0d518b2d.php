...
<div class="left f_l">
	...
	<div class="xbox left_contactbox">
	  <p>联系地址：<?php echo C('CFG_ADDRESS');?><br />
	  电话：<?php echo C('CFG_PHONE');?></p>
	</div>
	</div>
