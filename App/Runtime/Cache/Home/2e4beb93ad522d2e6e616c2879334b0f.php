...
<div class="warp" id="herd">
	...
	<div id="top_logo"><a href="<?php echo C('CFG_WEBURL');?>"></a></div>
</div>
<!--menu -->
<div id="menu">
	<ul>
		<li><a href="<?php echo C('CFG_WEBURL');?>">首 页</a></li>
		<?php
...
<a href="https://www.yuntaos.com" target="_blank">网站建设</a>
<?php
...
<div class="warp1 mt" id="bottom">
	<a href="<?php echo C('CFG_WEBURL');?>"><?php echo C('CFG_WEBNAME');?></a>版权所有
	<br />
	联系地址：<?php echo C('CFG_ADDRESS');?>  电话：<?php echo C('CFG_PHONE');?><br />
	Copyright © 2014-2020 XYHCMS. 行云海软件 版权所有 <a href="http://www.xyhcms.com" target="_blank">Power by XYHCMS</a> <?php echo C('CFG_STATS');?>
</div>
<?php
