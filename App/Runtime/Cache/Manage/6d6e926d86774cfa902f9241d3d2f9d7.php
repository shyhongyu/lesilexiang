...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/lslx/xyhai.php?s=/Attachment';
	    var APP	 = '/lslx/xyhai.php?s=';
	    var SELF='/lslx/xyhai.php?s=/Attachment/index';
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                            ...
                            <td>
                                <?php if(!empty($v['has_litpic'])): ?><strong class="text-success">有</strong><?php else: ?><strong class="text-muted"><i>无</i></strong><?php endif; ?>
                            </td>
