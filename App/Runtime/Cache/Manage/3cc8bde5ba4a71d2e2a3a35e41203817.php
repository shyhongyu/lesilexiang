...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/lslx/xyhai.php?s=/Templets';
	    var APP	 = '/lslx/xyhai.php?s=';
	    var SELF='/lslx/xyhai.php?s=/Templets/index';
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                            ...
                            <td>
                                <?php if(!empty($v['write'])): ?><strong class="text-success">是</strong><?php else: ?><strong class="text-muted"><i>否</i></strong><?php endif; ?>
                            </td>
